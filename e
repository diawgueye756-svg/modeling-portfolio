...
<body>
  ...
  <section id="portfolio">
    <h2>Portfolio</h2>
    <div class="gallery">
      <img src="street-nyc-001.jpg" alt="Papa modeling NYC 1" />
      <img src="street-nyc-003.jpg" alt="Papa modeling NYC 2" />
      <img src="street-nyc-004.jpg" alt="Papa modeling NYC 3" />
      <img src="street-nyc-001.jpg" alt="Papa modeling NYC 4 (repeat placeholder)" />
    </div>
  </section>

  <section id="contact">
    <h2>Contact</h2>
    <p>Email: <a href="mailto:diawgueye756@gmail.com">diawgueye756@gmail.com</a></p>
    <p>Phone: <a href="tel:+13472913788">347-291-3788</a></p>
    <form action="https://formspree.io/f/maykvlba" method="POST">
  ...
  <footer>
    &copy; 2025 Papa Gueye. All rights reserved.
  </footer>
</body>
</html>
